...
tags: ["Android", "Java", "Python", "Bluetooth Low Energy", "Raspberry Pi"]
---

Developed an **Java Android** application and a **Python** application that communicate via **Bluetooth Low Energy (BLE)**.
