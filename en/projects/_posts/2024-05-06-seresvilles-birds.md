...
{% include place-figure.html src="/assets/images/projects/seresville_birds/gameplay_seresville_birds.webp" alt="Seresville's birds gameplay" figure-nb="1" figure-text="Gameplay, picture mode" %}

{% include place-figure.html src="/assets/images/projects/seresville_birds/bird_list_seresville_birds.webp" alt="Seresville's birds bird list" figure-nb="2" figure-text="Bird list mode" %}
...
{% include place-figure.html src="/assets/images/projects/seresville_birds/parameters_seresville_birds.webp" alt="Seresville's birds parameters" figure-nb="3" figure-text="Parameters menu with audio settings" %}
